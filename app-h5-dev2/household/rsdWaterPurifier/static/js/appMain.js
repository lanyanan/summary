...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WaterLines = __webpack_require__(7);

	var _WaterPlate = __webpack_require__(10);

	var _SettingAnchor = __webpack_require__(11);

	var _SettingPanelPP = __webpack_require__(14);

	var _SettingPanelCO = __webpack_require__(16);

	var _SettingPanelPP2 = __webpack_require__(17);

	var _SettingPanelCO2 = __webpack_require__(18);

	var _SettingPanelRO = __webpack_require__(19);
	...
	var App = function (_BaseComponent) {
	    ...
	    function App(props) {
	        ...
	        _this.washWaterlines = _this.washWaterlines.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(_WaterPlate.WaterPlate, { washDevice: this.washDevice, washWaterlines: this.washWaterlines, washData: washData, MachineOperationState: this.state.MachineOperationState }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EchartsBar = __webpack_require__(8);

	var _EchartsLiner = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WaterPlate = exports.WaterPlate = React.createClass({
	    ...
	    componentWillReceiveProps: function componentWillReceiveProps(next) {
	        //console.log(this.props.MachineOperationState,'-------this.props-----------',next.MachineOperationState,'-------next.MachineOperationState-----------')
	        ...
	        if (appData.timerA && (next.washData.MachineOperationState != 1 || next.washData.online == 2 || next.washData.networkavailable == 2 || next.washData.K1State == '01' || next.washData.K2State == '01' || next.washData.BoosterPumpState == '01' || next.washData.FlowMeter1State == '01' || next.washData.FlowMeter2State == '01' || next.washData.MakeWaterOverTime == '01' || next.washData.LackWater == '01')) {
	            appData.washStart = 0;
	    ...
	    render: function render() {
	        console.log(this.props.washData.online, '---网络1--------');
	        ...
	        var washIndex = '',
	            washPlate = '';
	        //let washIndex =
	        washData.networkavailable == 2 || washData.online == 2 || washData.K1State == '01' || washData.K2State == '01' || washData.BoosterPumpState == '01' || washData.FlowMeter1State == '01' || washData.FlowMeter2State == '01' || washData.MakeWaterOverTime == '01' || washData.LackWater == '01' || washStatus != 1 || washData.washOver == 1 ? (washIndex = 'wash-index', washPlate = 'hidden') : (washIndex = 'hidden', washPlate = 'wash-plate');

	        //let washPlate = (
	        //    washData.online==2 ||
	        //    washData.networkavailable==2 ||
	        //    washData.K1State == '01' ||
	        //    washData.K2State == '01' ||
	        //    washData.BoosterPumpState == '01' ||
	        //    washData.FlowMeter1State == '01' ||
	        //    washData.FlowMeter2State == '01' ||
	        //    washData.MakeWaterOverTime == '01' ||
	        //    washData.LackWater == '01' ||
	        //
	        //    washStatus!=1 || washData.washOver==1) ? 'hidden':'wash-plate';

	        //<aside className='console'>
	        //    {' 调试打印: '}
	        //    {' 在线: '+washData.online }
	        //    {' 网络: '+washData.networkavailable }
	        //    {' K1State: '+washData.K1State }
	        //    {' K2State: '+washData.K2State }
	        //    {' NTCState: '+washData.NTCState }
	        //    {' BoosterPumpState: '+washData.BoosterPumpState }
	        //    {' FlowMeter1State: '+washData.FlowMeter1State }
	        //    {' FlowMeter2State: '+washData.FlowMeter2State }
	        //    {' MakeWaterOverTime: '+washData.MakeWaterOverTime}
	        //    {' LackWater: '+washData.LackWater }
	        //</aside>
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { onClick: this.props.washWaterlines, to: 'waterLines', className: 'flex flex-column top-plate' },
	                        React.createElement(
	                            'figure',
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    Link,
	                    { to: 'SettingPanelCO2', className: 'flex slide-item' },
	                    React.createElement(
	                        'span',
	                        { className: 'number' },
	                        React.createElement(
	                ...
	                React.createElement(
	                    Link,
	                    { to: 'SettingPanelRO', className: 'flex slide-item' },
	                    React.createElement(
	                        'span',
	                        { className: 'number' },
	                        React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InnerPage = __webpack_require__(15);
