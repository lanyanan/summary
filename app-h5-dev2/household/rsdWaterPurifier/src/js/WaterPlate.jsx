...
export const WaterPlate = React.createClass({
    ...
    componentWillReceiveProps:function(next){
        ...
        if(appData.timerA && ( next.washData.MachineOperationState!=1 ||
            next.washData.online==2 ||
            next.washData.networkavailable==2 || next.washData.K1State == '01' ||
            next.washData.K2State == '01' || next.washData.BoosterPumpState == '01' ||
            next.washData.FlowMeter1State == '01' || next.washData.FlowMeter2State == '01' ||
            next.washData.MakeWaterOverTime == '01' || next.washData.LackWater == '01' )) {
            appData.washStart=0;
	...
	render: function() {
       ...
       // console.log('---PureWaterTdsValue--',PureWaterTdsValue)
        ...
        let washIndex =
            ...
            washStatus!=1 ||
            washData.washOver==1) ? (washIndex='wash-index',washPlate='hidden'):(washIndex ='hidden',washPlate='wash-plate');
            ...
            <section className={toggleMinify} id="waterPlate">
                ...
                <figure>
                    <div className={washIndex} id="washIndex">
                        ...
                        <div onClick={this.props.washWaterlines} to="waterLines" className="flex flex-column top-plate">
