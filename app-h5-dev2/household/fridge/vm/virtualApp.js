...
var VirtualApp = function(){
    ...
    this.config = function(option) {
        ...
        setTimeout(function(){
            ...
            // 控制数据模拟
            webInterface.repaint({type:0, data:{freezerTemp:-18, refgTemp:3, lockSet:1, mode:4, refgSwitch:1, freezerSetTime:0, updateFlag:0}});
            // 运行数据模拟
            webInterface.repaint({type:1, data:{freezerTemp:-18, refgTemp:3, lockSet:1, mode:4, refgSwitch:2, freezerSetTime:6,online:1, deviceName:'惠而浦冰箱'}});
        }, 90);
    };
    // 接收web端传送的数据
