	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return React.createElement(_Graph.Graph, { chartData: this.state.chartData });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Graph = exports.Graph = function (_React$Component) {
	    ...
	    function Graph(props) {
	        ...
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Graph).call(this, props));
	        ...
	        _Store.Store.listen(function (data) {
	            if (!_this2.isMounted(_this2)) return;
	    ...
	    _createClass(Graph, [{
	        ...
	        key: 'tabBar',
	        value: function tabBar(e) {
	            var type = e.target.getAttribute("data-type");
	            _Actions.Actions.change(type);
	            ...
	            switch (type) {
	                case "week":
	                    ...
	                    break;
	                case "month":
	                    _Actions.Actions.getMonthLogData();
	                    ...
	                    break;
	                case "year":
	                    _Actions.Actions.getYearLogData();
	        ...
	        value: function render() {
	            ...
	            var weekChartstyle = this.setDisplayType(this.state.weekChart),
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { className: 'graRig', id: 'rigOne', 'data-type': 'week', onTouchEnd: this.tabBar.bind(this) },
	                        '周'
	                    ),
	                    React.createElement(
	                        'a',
	                        { className: 'graRig', id: 'rigTwo', 'data-type': 'month', onTouchEnd: this.tabBar.bind(this) },
	                        '月'
	                    ),
	                    React.createElement(
	                        'a',
	                        { 'data-type': 'year', id: 'rigThree', onTouchEnd: this.tabBar.bind(this) },
	                        '年'
	                    )
	                ),
	                React.createElement('div', { id: 'week', className: 'chart', style: weekChartstyle }),
	                React.createElement('div', { id: 'month', className: 'chart', style: monthChartstyle }),
	                React.createElement('div', { id: 'year', className: 'chart', style: yearChartstyle }),
	                React.createElement(
	                    'div',
