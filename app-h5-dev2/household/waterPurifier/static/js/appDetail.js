...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Bound = __webpack_require__(9);
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { id: 'indicatorContainer', className: '' },
	                        React.createElement('img', { src: './../static/img/wrapCon.png', id: 'prgLogo' })
	                    ),
	                    React.createElement(
	                        'span',
	                ...
	                React.createElement(
	                    'a',
	                    { className: 'detail-reset', href: 'xt://xt_reset' },
	                    '滤芯复位'
	                )
	            );
	        }
...
/***/ function(module, exports) {
	...
	'refresh', 'change', 'getWeekLogData', 'getMonthLogData', 'getYearLogData', 'getMoreMonthLogData', 'getTypeData']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var URL = "",
	    options = {};
	var DOMIN = "http://" + getQueryString("host");
	...
	var Store = exports.Store = Reflux.createStore({
	    ...
	    fillArray: function fillArray(ary, n) {
	        var res = [];
	    ...
	    onChange: function onChange(type) {
	        var rigOne = document.getElementById("rigOne");
	        var rigTwo = document.getElementById("rigTwo");
	        var rigThree = document.getElementById("rigThree");
	    ...
	    changeData: function changeData(type, length, data) {
	        var seriesData = new Array(length),
	            waterYield = 0;
	    ...
	    getData: function getData(type, xData) {
	        var _this = this;
	    ...
	    onGetWeekLogData: function onGetWeekLogData() {
	        var xData = ["周一", "周二", "周三", "周四", "周五", "周六", "周日"];
	        this.getData('day', xData);
	    },
	    onGetMonthLogData: function onGetMonthLogData() {
	        var xData = ["第一周", "第二周", "第三周", "第四周", "第五周"];
	        this.getData('week', xData);
	    },
	    onGetYearLogData: function onGetYearLogData() {
	    ...
	    //}
	    onGetTypeData: function onGetTypeData(data) {
	        var _this = this,
	            length = void 0,
	            type = void 0;
	        ...
	        //安卓用的post  ios未用二代框架  挖坑20160921，gl，gg。
	        options.appId = 10130, options.deviceId = getQueryString("deviceId"), options.mac = getQueryString("mac"), options.date = this.getDate(), options.type = data;
	        //console.log(options,typeof options,URL);
	        ...
	        het.get(URL, options, function (data) {
	            //console.log(JSON.parse(data), data.ExtenWater, 'ssssssssssssssssssssss');
	            console.log(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Bubble = __webpack_require__(10);

	var _Store = __webpack_require__(8);

	var _Actions = __webpack_require__(7);

	var _BaseComponentClass = __webpack_require__(11);
	...
	var Bound = exports.Bound = function (_React$Component) {
	    _inherits(Bound, _React$Component);

	    function Bound(props) {
	        _classCallCheck(this, Bound);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Bound).call(this, props));
	    ...
	    _createClass(Bound, [{
	        ...
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            _Actions.Actions.refresh();
	            _Actions.Actions.getWeekLogData();
	        ...
	        key: 'locationHref',
	        value: function locationHref(e) {
	            e.preventDefault();
	            location.href = 'xt://xt_more_daily_record';
	        }
	    }, {
	        key: 'stopE',
	        value: function stopE(e) {
	            e.preventDefault();
	            e.stopPropagation();
	        }
	    }, {
	        ...
	        value: function render() {
	            var now = new Date().getTime(),
	                items = this.state.macFilter ? this.state.macFilter : [];
	            //console.log('----------------items', items, items instanceof Array);
	            var pureWaterTds = this.state.pureWaterTds;
	            var sourceWaterTds = this.state.sourceWaterTds;
	            var waterTemp = this.state.waterTemp;
	            var flowMeter = this.state.flowMeter < 1000 ? this.state.flowMeter + "升" : (this.state.flowMeter / 1000).toFixed(2) + "吨";
	            var mTime = this.state.endBillTime - now;
	            mTime = mTime > 0 && mTime < 86400000 ? 86400000 : mTime;
	            mTime = mTime < 0 ? 0 : mTime;
	            var day = this.format(Math.floor(mTime / 1000 / 60 / 60 / 24));
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'div',
	                                { className: 'boundRingContent' },
	                                React.createElement(
	                                    'div',
	                                    { className: 'sourceWaterData' },
	                                    React.createElement(
	                                        'p',
	                                        null,
	                                        React.createElement('span', { className: 'sourceTDSNumber' }),
	                                        React.createElement(
	                                            'span',
	                                            null,
	                                            '净化前/后(TDS)'
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: 'bubble', onTouchStart: this.stopE },
	                            React.createElement(_Bubble.Bubble, null)
	                        ),
	                        mTime > 0 ? React.createElement(
	                            'div',
	                            { className: 'stateDiscrib' },
	                            React.createElement(
	                                'p',
	                                null,
	                                React.createElement(
	                                ...
	                                React.createElement(
	                                    'span',
	                                    {
	                                        className: 'waterNumber' },
	                                    flowMeter
	                                )
	                            )
	                        ) : React.createElement(
	                            'div',
	                            { className: 'serviceExpire' },
	                            React.createElement(
	                                'span',
	                                null,
	                                '您的租凭服务已到期。'
	                    ...
	                    React.createElement(
	                        'span',
	                        { className: 'purifierMessage-title' },
	                        '滤芯状态'
	                    ),
	                    React.createElement(
	                        'ul',
	                        { className: 'purifierMessage' },
	                        items.map(function (it, idx) {
	                            return React.createElement(
	                                'li',
	                                { className: 'purifierMessage-li', key: idx, title: idx },
	                                React.createElement(
	                                    'div',
	                                    { className: 'purifierMessage-num' },
	                                    idx + 1
	                                ),
	                                React.createElement(
	                                    'div',
	                                    { className: 'purifierMessage-content' },
	                                    React.createElement(
	                                        'dl',
	                                        { className: 'purifierMessage-content-dl' },
	                                        React.createElement(
	                                            'dt',
	                                            null,
	                                            it.filterName
	                                    ...
	                                    React.createElement(
	                                        'a',
	                                        { className: 'purifierMessage-content-r',
	                                            style: { color: it.scale <= 0 ? '#ff3600' : '#18dffb' } },
	                                        it.scale <= 0 ? '已过期' : it.scale * 100 + '%'
	                                    )
	                                )
	                            );
	                        }.bind(this))
	                    ...
	                    React.createElement('div', { id: 'charts' }),
	                    React.createElement(
	                        'a',
	                        { className: 'more-mes', onTouchEnd: this.locationHref },
	                        '查看更多用水日志'
	                    ),
	                    React.createElement(
	                        'div',
	                        ...
	                        React.createElement(
	                            'div',
	                            { id: 'warning' },
	                            React.createElement('img', { src: '../static/img/warning.png' }),
	                            React.createElement(
	                                'span',
	                                null,
	                                '网络错误，数据加载失败'
...
/***/ function(module, exports) {
	...
	*/
	...
	var Bubble = exports.Bubble = React.createClass({
	    displayName: 'Bubble',
	    ...
	    render: function render() {
	        return React.createElement('canvas', { id: 'bubbleCanvas' });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var GlobalModel = __webpack_require__(15);
	    ...
	    var ComponentModel = __webpack_require__(31);
	    ...
	    var timsort = __webpack_require__(97);
	    ...
	    var defaultLoadingEffect = __webpack_require__(105);
	    /**
	     * Show loading effect
	    ...
	    echarts.registerVisual(PRIORITY_VISUAL_GLOBAL, __webpack_require__(106));
	    echarts.registerPreprocessor(__webpack_require__(107));
	    ...
	    // --------
	    //
	    echarts.List = __webpack_require__(109);
	    echarts.Model = __webpack_require__(24);

	    echarts.graphic = __webpack_require__(55);
	    echarts.number = __webpack_require__(19);
	    echarts.format = __webpack_require__(18);
	    echarts.matrix = __webpack_require__(23);
	    echarts.vector = __webpack_require__(22);
	    echarts.color = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var zrUtil = __webpack_require__(16);
	    var modelUtil = __webpack_require__(17);
	    ...
	    var globalDefault = __webpack_require__(35);
	    ...
	    zrUtil.mixin(GlobalModel, __webpack_require__(36));
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var nubmerUtil = __webpack_require__(19);
	    var Model = __webpack_require__(24);
	    var zrUtil = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(16);
	    var numberUtil = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var vec2 = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    mixin(Model, __webpack_require__(28));
	    mixin(Model, __webpack_require__(29));
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var getLineStyle = __webpack_require__(27)(
	        [
	            ['lineWidth', 'width'],
	            ['stroke', 'color'],
	            ['opacity'],
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        getAreaStyle: __webpack_require__(27)(
	            [
	                ['fill', 'color'],
	                ['shadowBlur'],
	                ['shadowOffsetX'],
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var getItemStyle = __webpack_require__(27)(
	        [
	            ['fill', 'color'],
	            ['stroke', 'borderColor'],
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    zrUtil.mixin(ComponentModel, __webpack_require__(34));
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(16);
	    var clazz = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var modelUtil = __webpack_require__(17);
	    var ComponentModel = __webpack_require__(31);
	    var colorPaletteMixin = __webpack_require__(36);
	    var env = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    graphic.BoundingRect = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Global defines
	    ...
	    var Animation = __webpack_require__(98);
	    var HandlerProxy = __webpack_require__(101);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var util = __webpack_require__(16);
	    var Draggable = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// https://developer.apple.com/videos/wwdc2014/#236
	    ...
	    var requestAnimationFrame = __webpack_require__(100);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var eventTool = __webpack_require__(99);
	    var zrUtil = __webpack_require__(16);
	    var Eventful = __webpack_require__(45);
	    var env = __webpack_require__(14);
	    var GestureMgr = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var eventUtil = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Compatitable with 2.0
	    ...
	    var zrUtil = __webpack_require__(16);
	    var compatStyle = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Model = __webpack_require__(24);
	    var DataDiffer = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var completeDimensions = __webpack_require__(114);
	    var zrUtil = __webpack_require__(16);
	    var modelUtil = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var zrUtil = __webpack_require__(16);
	    var symbolUtil = __webpack_require__(118);
	    var graphic = __webpack_require__(55);
	    var numberUtil = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    // Grid view
	    __webpack_require__(13).extendComponentView({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var factory = exports;
	    ...
	    var layout = __webpack_require__(33);
	    var axisHelper = __webpack_require__(126);

	    var zrUtil = __webpack_require__(16);
	    var Cartesian2D = __webpack_require__(132);
	    var Axis2D = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var OrdinalScale = __webpack_require__(127);
	    var IntervalScale = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var zrUtil = __webpack_require__(16);
	    var Cartesian = __webpack_require__(133);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(16);
	    var Axis = __webpack_require__(135);
	    var axisLabelInterval = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var ComponentModel = __webpack_require__(31);
	    var zrUtil = __webpack_require__(16);
	    var axisModelCreator = __webpack_require__(139);
	    ...
	    zrUtil.merge(AxisModel.prototype, __webpack_require__(141));
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var axisDefault = __webpack_require__(140);
	    var zrUtil = __webpack_require__(16);
	    var ComponentModel = __webpack_require__(31);
	    var layout = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var AxisView = __webpack_require__(13).extendComponentView({
