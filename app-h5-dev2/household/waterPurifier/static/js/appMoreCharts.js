...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WeekComp = __webpack_require__(149);

	var _MonthComp = __webpack_require__(150);

	var _YearComp = __webpack_require__(151);
	...
	var App = function (_BaseComponent) {
	    ...
	    function App(props) {
	        ...
	        var type = _this.state.cn;
	        _Actions.Actions.getTypeData(type);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                'div',
	                { className: 'graMain', style: { marginTop: this.state.headerTop + 'px' } },
	                React.createElement(
	                    'p',
	                    null,
	                    '今天：',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { className: 'graRig', id: 'rigOne', 'data-type': 'week', title: '1',
	                            style: { background: this.state.cn == '1' ? '#17dff2' : '', color: this.state.cn == '1' ? '#fff' : '#17dff2' },
	                            onTouchEnd: this.getAttr.bind(this) },
	                        '周'
	                    ),
	                    React.createElement(
	                        'a',
	                        { className: 'graRig', id: 'rigTwo', 'data-type': 'month', title: '2',
	                    ...
	                    React.createElement(
	                        'a',
	                        { 'data-type': 'year', id: 'rigThree', title: '3',
	                            style: { background: this.state.cn == '3' ? '#17dff2' : '', color: this.state.cn == '3' ? '#fff' : '#17dff2' },
	                            onTouchEnd: this.getAttr.bind(this) },
	                        '年'
	                    )
	                ),
	                this.state.cn == '1' ? React.createElement(_WeekComp.WeekComp, { mydata: this.state.data }) : '',
	                this.state.cn == '2' ? React.createElement(_MonthComp.MonthComp, { mydata: this.state.data }) : '',
	                this.state.cn == '3' ? React.createElement(_YearComp.YearComp, { mydata: this.state.data }) : ''
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var WeekComp = exports.WeekComp = React.createClass({
	    displayName: 'WeekComp',
	    ...
	    render: function render() {
	        ...
	        if (this.props.mydata !== 'undefined') {
	            (function () {
	                var chart = ReactDOM.findDOMNode(_this.refs.chart),
	                    chartDate = _this.props.mydata ? _this.props.mydata : '';
	                setTimeout(function () {
	        ...
	        return React.createElement('div', { id: 'week', className: 'chart', ref: 'chart' });
	    },
	    componentDidMount: function componentDidMount() {
	        ...
	        if (this.props !== 'undefined') {
	            (function () {
	                var chart = ReactDOM.findDOMNode(_this2.refs.chart),
	                    chartDate = _this2.props.mydata ? _this2.props.mydata : '';
	                setTimeout(function () {
	                    var myChart_week = echarts.init(chart);
	                    // 指定图表的配置项和数据
	                    var option_week = {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Created by Administrator on 2016-09-13.
	 */
	var MonthComp = exports.MonthComp = React.createClass({
	    displayName: 'MonthComp',
	    componentDidMount: function componentDidMount() {
	        var chart = ReactDOM.findDOMNode(this.refs.chart),
	            chartDate = this.props.mydata ? this.props.mydata : '';
	        setTimeout(function () {
	    ...
	    render: function render() {
	        ...
	        return React.createElement('div', { id: 'month', className: 'chart', ref: 'chart' });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Created by Administrator on 2016-09-13.
	 */
	var YearComp = exports.YearComp = React.createClass({
	    displayName: 'YearComp',
	    componentDidMount: function componentDidMount() {
	        var chart = ReactDOM.findDOMNode(this.refs.chart),
	            chartDate = this.props.mydata ? this.props.mydata : '';
	        setTimeout(function () {
	    ...
	    render: function render() {
	        ...
	        return React.createElement('div', { id: 'year', className: 'chart', ref: 'chart' });
	    }
	});
