...
(function(global, factory) {
    ...
    Calendar.prototype = $.extend({}, Widget.prototype, {
        ...
        tplCalendarWrap: function() {
            ...
            html += '<span class="pre-mon"></span><span class="titleicon"></span>' +'<span class="title-wrap">' + '<span class="year">' + this.get('year') + '</span> 年 ' + '<span class="month">' + this.get('month') + '</span> 月 ' + '<span class="head-text">' + this.get('headText') + '</span>' + '</span>' + '<span class="next-mon"></span>' + '</div>' + '<div class="days">' + '<span>S</span><span>M</span><span>T</span><span>W</span><span>T</span><span>F</span><span>S</span>' + '</div>' + '</div>';
