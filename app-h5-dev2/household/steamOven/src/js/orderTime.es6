...
export const OrderTime = React.createClass({
	...
	render: function() {
		...
		let selecttitle = this.props.title||'预约时间';
	    ...
	    return (
	    	<section style={{visibility:this.state.timeDisplay?"initial":"hidden",opacity:this.state.showOpacity}} ref='ordertime' className='Ordertime'>
		    	<section onTouchEnd={this.cancelclock}></section>
		        <section className="ordertime" onTouchMove={this.endDefault}>
