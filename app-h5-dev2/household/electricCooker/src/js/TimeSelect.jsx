		        ...
		        <section className="timeselect" onTouchMove={this.endDefault}>
		        	...
		        	<section className='time'>
		        		...
		        		<section className='timetext'>
		        			<span className='timeLeft'>电饭煲将在</span>
		        			<span className='hour' style={{left:minuteshow?42+'%':53+'%',display:hourshow?'inline-block':'none'}}>时</span>
		        			<span className='minute' style={{display:minuteshow?'inline-block':'none',left:hourshow?68+'%':53+'%'}}>分</span>
		        			<span className='status'>{statusname}</span>
		        		</section>
		        		<section className='hourvalue flex-column' style={{top:hourtop+'%',left:minuteshow?32+'%':45+'%',display:hourshow?'':'none'}}>
