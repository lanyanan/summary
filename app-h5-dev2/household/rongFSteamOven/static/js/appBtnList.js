	...
	var App = function (_React$Component) {
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function handleMode() {
	            //模式选择 (0-等待模式，1-上烧烤模式，2-下烧烤模式，3-上下烧烤模式，
	        ...
	        value: function render() {
	            ...
	            var modeArry = ['模式', '上烤', '下烤', '上下烤', '蒸煮', '高温蒸烤', '消毒', '解冻', '发酵'];
	            var deviceSwitch = parseInt(this.state.DeviceSwitch) || 1;
	            var stoveStatus = parseInt(this.state.StoveStatus) || 0; //0关  1开
	            var selectModel = this.state.selectModel || 0;
	            var curWorkMode = parseInt(this.state.CurrentWorkMode) || 0;

	            var statusArry = ['待机中', '烘焙中', '已关机', '暂停', '烘培完成'];
	            var workText = deviceSwitch == 1 ? statusArry[2] : this.isWait() ? statusArry[0] : (0, _constants.isFinish)(this.state) ? statusArry[4] : cookBookCurIsPause == 1 ? statusArry[3] : statusArry[1];
	            var mode = parseInt(this.state.CurrentWorkMode) || 0,
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'article',
	                        { className: 'flex-cell', onTouchEnd: this.handleOnOff.bind(this) },
	                        React.createElement('img', { style: { opacity: online == 2 ? 0.3 : 1 },
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('img', { style: { opacity: stoveStatus == 1 ? 1 : 0.3 },
	                    ...
	                    React.createElement(
	                        'article',
	                        { className: 'flex-cell', onTouchEnd: this.handleMode.bind(this) },
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('img', { style: { opacity: this.isCanCancel() ? 1 : 0.3 },
