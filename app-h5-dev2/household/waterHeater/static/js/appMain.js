...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SetingPage = __webpack_require__(8);

	var _WorkingPage = __webpack_require__(10);

	var _CircleAnimation = __webpack_require__(46);

	var _Wave = __webpack_require__(44);

	var _WaveAnimation = __webpack_require__(47);

	var _WasherWave = __webpack_require__(48);

	var _WasherCommonData = __webpack_require__(6);

	var _ModeSetingPage = __webpack_require__(49);
	...
	var deviceNaveClassName = 'device_nav';
	var showWorkingPannelImage = false;
	var appError = {
	    BK1: {
	        value: 0,
	        level: 1,
	...
	var App = function (_BaseComponent) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function handleToSettingPage(e) {
	            var onlineStatus = this.state.online != '2' && this.state.onlineStatus || false;
	            var childrenLockOn = this.state.set_childerLockOn !== undefined ? this.state.set_childerLockOn : false;
	            var switchLockOn = this.state.set_switchLockOn !== undefined ? this.state.set_switchLockOn : false;
	            var netWorkStatus = this.state.networkavailable == 2;
	            if (netWorkStatus) {
	                het.toast("当前网络不可用");
	                return;
	            }
	        ...
	        key: 'handleSetingPageHandle',
	        value: function handleSetingPageHandle(modeIndex) {
	            this.setState({
	                showModeSetingPage: false
	            });
	        ...
	        key: 'handleToWorkingPage',
	        value: function handleToWorkingPage() {
	        ...
	        key: 'childerLockon',
	        value: function childerLockon() {
	            _Actions.Actions.setWaterHeaterChildOn();
	        }
	    }, {
	        key: 'addTempAction',
	        value: function addTempAction() {
	            if (!showWorkingPannelImage) {
	                return;
	            }

	            _Actions.Actions.addTempAction();
	        }
	    }, {
	        key: 'subTempAction',
	        value: function subTempAction() {
	            if (!showWorkingPannelImage) {
	                return;
	            }
	            _Actions.Actions.subTempAction();
	        }
	    }, {
	        key: 'handleAlert',
	        value: function handleAlert() {
	            ...
	            var hasError = false;
	            var ErrorMessage = '';
	            var lastErrorLevel = 18; // 17最低  最新显示告警级别
	        ...
	        value: function render() {
	            ...
	            var onlineStatus = this.state.online != '2' && this.state.onlineStatus || false; // 在线状态 true 在线
	            var childrenLockOn = this.state.set_childerLockOn || false;
	            var switchLockOn = this.state.set_switchLockOn !== undefined ? this.state.set_switchLockOn : false;
	            var waterHeaterTemp = this.state.waterHeaterTemp !== undefined ? this.state.waterHeaterTemp : 25;

	            var isWorking = onlineStatus && !childrenLockOn || this.state.isWorking;
	            var workMode = this.state.waterHeaterWorkMode !== undefined ? this.state.waterHeaterWorkMode : 0;

	            console.log('APPmainMode: ' + workMode + ' set_switchLockOn: ' + this.state.set_switchLockOn + ' waterHeaterTemp: ' + this.state.waterHeaterTemp);
	            var workModeImage = isWorking ? '../static/image/mode/m-' + workMode + '-on.png' : "../static/image/heater/main_mode_image.png";

	            var waterTemp = waterHeaterTemp + '℃';
	            console.log("######################waterHeaterTemp:" + waterHeaterTemp + "this.state.waterHeaterTemp" + this.state.waterHeaterTemp);
	            var worksts = this.state.worksts || 1;
	            var workstatus = '';
	            var workAlert = '点击更换模式';
	            if (onlineStatus && switchLockOn) {
	                // workstatus = '运行中';
	                if (isWorking) {
	                    workstatus = _WasherCommonData.washerModeS[workMode].name + '模式运行中';
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement('div', { className: deviceNaveClassName }),
	                    React.createElement(
	                        'div',
	                        { className: 'diveceView' },
	                        React.createElement(
	                            'div',
	                            { className: 'device_padding' },
	                            '   '
	                        ),
	                        React.createElement(
	                            'div',
	                            { className: 'deviceHeaterImage' },
	                            React.createElement(
	                                'div',
	                                { className: 'flex tempControl', style: { 'opacity': showWorkingPannelImage ? '1' : '0' } },
	                                React.createElement(
	                                    'div',
	                                    { className: 'flex-cell', onTouchStart: this.subTempAction.bind(this) },
	                                    React.createElement('img', { src: '../static/image/heater/tempSub.png', width: '20', height: '20' })
	                                ),
	                                React.createElement(
	                                    'div',
	                                    { className: 'flex-cell' },
	                                ...
	                                React.createElement(
	                                    'div',
	                                    { className: 'flex-cell', onTouchStart: this.addTempAction.bind(this) },
	                                    React.createElement('img', { src: '../static/image/heater/tempAdd.png', width: '20', height: '20' })
	                                )
	                            ),
	                            React.createElement(
	                                'div',
	                                { className: 'device_image' },
	                                React.createElement('img', { src: '../static/image/heater/heater_main.png' })
	                            )
	                        ),
	                        React.createElement(
	                            'div',
	                            ...
	                            React.createElement(
	                                'dl',
	                                { className: "wash_children_lock " + (switchLockOn ? ' ' : 'off'), onTouchStart: this.childerLockon.bind(this) },
	                                React.createElement(
	                                    'dd',
	                                    null,
	                                    React.createElement('img', { src: "../static/image/washer/childerlock_" + (childrenLockOn ? "on.png" : "off.png") })
	                                ),
	                                React.createElement(
	                                    'dt',
	                                    null,
	                            ...
	                            React.createElement(
	                                'dl',
	                                { className: "wash_switch " + (switchLockOn ? ' ' : 'off'), onTouchStart: this.switchAction.bind(this) },
	                                React.createElement(
	                                    'dd',
	                                    null,
	                                    React.createElement('img', { src: '../static/image/washer/wash_switch.png' })
	                                ),
	                                React.createElement(
	                                    'dt',
	                                    null,
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement('img', { src: workModeImage })
	                        ),
	                        React.createElement(
	                            'div',
	                            { className: 'deviceSeting_alert', style: { 'opacity': childrenLockOn ? '1' : '0.5' } },
	                            workAlert
	                        ),
	                        React.createElement(
	                            'div',
	                            { className: 'device_showStatusView', style: { 'display': showWorkingPannelImage ? 'block' : 'none' }, onTouchStart: this.handleToWorkingPage.bind(this) },
	                            React.createElement('img', { src: '../static/image/heater/arrow_up.png', width: '20', height: '20' })
	                        )
	                    )
	                ),
	                ...
	                React.createElement(_ModeSetingPage.ModeSetingPage, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var orderSelect = {
	    ...
	    hourstep: 1,
	    hourunit: '°C',
	    hourarray: _WasherCommonData.waterTempArray,
	    maxhour: _WasherCommonData.waterTempArray[20],
	    minhour: _WasherCommonData.waterTempArray[0],
	    defaulthour: _WasherCommonData.waterTempArray[10],
	...
	var Seting = exports.Seting = function (_BaseComponent) {
	    ...
	    _createClass(Seting, [{
	        ...
	        value: function handleTouchTap(e) {
	            var waterHeaterWorkMode = this.state.set_waterMode;
	            var modelTemp = waterHeaterWorkMode == 0 ? 35 : waterHeaterWorkMode == 1 ? 34 : waterHeaterWorkMode == 2 ? 35 : waterHeaterWorkMode == 3 ? 45 : waterHeaterWorkMode == 4 ? 30 : waterHeaterWorkMode == 5 ? 38 : waterHeaterWorkMode == 6 ? 40 : 35;
	        ...
	        value: function handleMode(e) {
	            ...
	            console.log("mode:" + _WasherCommonData.washerModeS[index].name);
	        ...
	        value: function submitClock(h, m) {
	            ...
	            var tableCellIndex = this.state.selectIndex;
	            switch (tableCellIndex) {
	                case 0:
	                    var index = _WasherCommonData.waterTempArray.indexOf(h);
	        ...
	        value: function render() {
	            ...
	            if (this.state.isFirtInput != undefined && this.state.isFirtInput) {
	                ...
	                _Actions.Actions.setingPageSet(false);
	            }
	            var selectIndex = this.state.selectIndex;
	            var selectMode = orderSelect;

	            var navigation = isIOS ? ' ios' : ' android';

	            var orderTime = _WasherCommonData.waterTempArray[this.state.set_waterTempIndex] + '℃';
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    _WasherCommonData.washerModeS.map(function (o) {
	                        return React.createElement(
	                            'dd',
	                            { style: { 'backgroundImage': 'url(../static/image/mode/m-' + o.id + (o.id == this.state.set_waterMode ? '-on.png)' : '-off.png)') },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WorkingLoadingAnimation = __webpack_require__(45);
	...
	var Working = exports.Working = function (_React$Component) {
	    _inherits(Working, _React$Component);
	    ...
	    _createClass(Working, [{
	        ...
	        value: function render() {
	            ...
	            var intemp = this.props.intemp !== undefined ? this.props.intemp : 0; //进水口温度
	            var outtemp = this.props.outtemp !== undefined ? this.props.outtemp : 0; //出水口温度
	            var showertm = this.props.showertm !== undefined ? this.props.showertm : 0; //洗浴时长
	            var waterspd = this.props.waterspd !== undefined ? this.props.waterspd : 0; //水流速度
	            var devicetm = this.props.devicetm !== undefined ? this.props.devicetm : 0; //累计通电时长
	            var waterall = this.props.waterall !== undefined ? this.props.waterall : 0; //累计耗水量
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { onTouchStart: this.handleToMainPage.bind(this) },
	                    _react2.default.createElement('img', { src: '../static/image/heater/arrow_down.png', width: '20', height: '20' })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tableCell flex' },
	                    _react2.default.createElement(
	                        'dl',
	                        { className: 'flex-cell' },
	                        _react2.default.createElement(
	...
	var Wave = exports.Wave = function (_Component) {
	    ...
	    function Wave(props) {
	        ...
	        _this2.state = {
	            ...
	            yy_wave_color: ['rgba(00,134,255,0.2)', 'rgba(00,134,255,0.4)', 'rgba(00,134,255,1)'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WaveAnimation = exports.WaveAnimation = function (_Component) {
	    _inherits(WaveAnimation, _Component);

	    function WaveAnimation(props) {
	        _classCallCheck(this, WaveAnimation);

	        var _this2 = _possibleConstructorReturn(this, (WaveAnimation.__proto__ || Object.getPrototypeOf(WaveAnimation)).call(this, props));
	        ...
	        _this2.configPar = {
	            colorS: ['rgba(42,204,250,0.4)', 'rgba(42,204,250,0.2)', 'rgba(255,255,255,2)']
	        };
	        return _this2;
	    }
	    ...
	    _createClass(WaveAnimation, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var drawing = document.querySelector('#wavecanvas');
	            drawing.width = window.screen.width;
	            var context = drawing.getContext('2d');
	        ...
	        key: 'globalAttenuationFn',
	        value: function globalAttenuationFn(x) {
	            var K = this.state.K;
	            return Math.pow(K * 4 / (K * 4 + Math.pow(x, 4)), K * 2);
	        }
	    }, {
	        key: 'drawLine',
	        value: function drawLine(attenuation) {
	            var context = this.state.context;
	            var drawing = this.state.drawing;
	            context.clearRect(0, 0, drawing.width, drawing.height);
	        ...
	        key: 'draw',
	        value: function draw() {
	            var phase = (this.state.phase + this.state.speed) % (Math.PI * 64);
	            this.setState({
	                phase: phase
	            });
	            this.drawLine(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ModeSetingPage = undefined;
	...
	var ModeSetingPage = exports.ModeSetingPage = function (_React$Component) {
	    _inherits(ModeSetingPage, _React$Component);

	    function ModeSetingPage(props) {
	        _classCallCheck(this, ModeSetingPage);

	        var _this = _possibleConstructorReturn(this, (ModeSetingPage.__proto__ || Object.getPrototypeOf(ModeSetingPage)).call(this, props));
	    ...
	    _createClass(ModeSetingPage, [{
	        ...
	        value: function handleTouchAction() {
	            if (typeof this.props.setingModeFunction === 'function') {
	        ...
	        value: function render() {
	            ...
	            var workingPageHeight = 216;
	            var translateYValue = workingPageHeight + height;
	            var translateYValuePX = translateYValue + 'px';
	            var style = this.props.show ? { transform: 'translateY(0px)', webkitTransform: 'translateY(0px)' } : { transform: 'translateY(' + translateYValuePX + ')', WebkitTransform: 'translateY(' + translateYValuePX + ')' };
	            var currentMode = this.state.waterMode != undefined ? this.state.waterMode : this.props.workMode;

	            console.log("style " + this.props.show + " " + JSON.stringify(style) + " currentMode" + this.state.waterMode);

	            return React.createElement(
	                'div',
	                { className: 'ModeSetingPage ', style: style, onTouchStart: this.handleTouchAction.bind(this) },
	                React.createElement(
	                    'div',
	                    { className: 'ModeSeing' },
	                    React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        _WasherCommonData.washerModeS.map(function (o) {
	                            return React.createElement(
	                                'dd',
	                                { style: { 'backgroundImage': 'url(../static/image/mode/m-' + o.id + (o.id == currentMode ? '-on.png)' : '-off.png)') },
