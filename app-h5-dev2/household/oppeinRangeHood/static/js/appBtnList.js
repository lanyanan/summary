	...
	var App = function (_BaseComponent) {
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function render() {
	            ...
	            var switchStatus = networkavailable == 2 || online == 2 || runstatus === 7 ? "flex-cell  triggered" : "flex-cell";
	            var lightStatus = networkavailable == 2 || online == 2 || lightstatus == 1 || runstatus === 7 ? "flex-cell  triggered" : "flex-cell";
	            var breathStatus = networkavailable == 2 || online == 2 || runstatus === 7 || runstatus == 2 ? "flex-cell  triggered" : "flex-cell";
	            ...
	            var runningOkSwitch = online == 2 || networkavailable == 2 || water == 1 ? false : true;
	            var runningOk = online == 2 || networkavailable == 2 || water == 1 || runstatus === 3 ? false : true;
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'article',
	                        { 'data-mode': '1', className: switchStatus, onClick: changeMode, style: runningOkSwitch ? { opacity: 1 } : { opacity: .5 } },
	                    ...
	                    React.createElement(
	                        'article',
	                        { 'data-mode': '0', className: lightStatus, onClick: changeMode, style: runningOk ? { opacity: 1 } : { opacity: .5 } },
	                        React.createElement('img', { src: '../static/img/btnlist/2.png', alt: '' }),
	                        React.createElement(
	                            'p',
	                            null,
	                            '\u7167\u660E'
	                    ...
	                    React.createElement(
	                        'article',
	                        { 'data-mode': '3', className: breathStatus, onClick: changeMode, style: runningOk ? { opacity: 1 } : { opacity: .5 } },
	                        React.createElement('img', { src: '../static/img/btnlist/3.png', alt: '' }),
	                        React.createElement(
	                            'p',
	                            null,
	                            '\u6362\u6C14'
