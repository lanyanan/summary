...
export const Taste = React.createClass({
	...
	render: function() {
	    ...
	    return (
	    	<section  ref='timeSelect' className='timeSelect' >
		    	<section onTouchEnd={this.cancelclock}></section>
		        <section className="tasteselect" onTouchMove={this.endDefault}>
		        	<section className='selecttaste'>
		        	  <section className='select-btn flex'>
		        		<span className='flex-cell' onTouchEnd={this.cancelclock}>取消</span>
		        		<span className='flex-cell' onTouchEnd={this.submitclock}>确定</span>
		        	</section>
		        	<p className="select-taste">口感</p>
		        	</section>
		        	<section className='time'>
		        		...
		        		<section  data-type='minute'  style={{display:'inline-block',width:'100%',left:'0%'}}
		        			onTouchStart={this.startrange} onTouchMove={this.moverange}
		        			onTouchEnd={this.endrange} className='minute'>
		        		</section>
		        		{/*<section className='timetext'>
		        			<span className='hour' style={{left:minuteshow?33+'%':53+'%',display:hourshow?'inline-block':'none'}}>适中</span>
		        		...
		        		<section  className='minutevalue flex-column' style={{top:'0%',display:minuteshow?'':'none',left:'0%'}} >
		        			...
		        			<span className='taste-line3'>{minutearr[minuteindex]}</span>
