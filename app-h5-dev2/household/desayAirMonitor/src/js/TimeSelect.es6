		        ...
		        <section className="timeselect" onTouchMove={this.endDefault}>
		        	...
		        	<section className='time'>
		        		...
		        		<section className='timetext'>
		        			...
		        			<span className='minute' style={{display:'none',left:hourshow?66+'%':53+'%'}}>分</span>
		        		...
		        		<section  className='minutevalue flex-column' style={{top:minutetop+'%',display:minuteshow?'':'none',left:0+'%'}}>
