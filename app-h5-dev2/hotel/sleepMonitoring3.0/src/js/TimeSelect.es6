...
export const TimeSelect = React.createClass({
	...
	render: function() {
	    ...
	    return (
	    	<section style={{visibility:this.state.timeDisplay?"initial":"hidden",opacity:this.state.showOpacity}} ref='timeSelect' className='timeSelect' onTouchEnd={this.submitclock}>
		        ...
		        <section className="timeselect" onTouchMove={this.endDefault}>
		        	...
		        	<section className='selectbtn flex'>
		        		...
		        		<span className='flex-cell' >确定</span>
		        	</section>
		        </section>
	        </section>
	    );
