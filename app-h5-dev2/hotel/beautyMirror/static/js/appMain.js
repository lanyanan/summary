...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = exports.Store = Reflux.createStore({
					...
					onGetData: function onGetData() {
									...
									var getDeviceId = function getDeviceId(resolve, reject) {
													if (!deviceId) {
																	$.ajax({
																					type: "POST",
									...
									var getLastData = function getLastData(resolve, reject) {
													$.ajax({
																	type: "POST",
									...
									var p = new _Promise2.default(getDeviceId).then(function () {
													return new _Promise2.default(getLastData);
									}, function (rejected) {
