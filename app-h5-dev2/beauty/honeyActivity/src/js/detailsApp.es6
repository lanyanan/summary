...
// 创建React组件
export class DetailsApp extends BaseComponent {
    constructor(props) {
        super(props);
        this.state = {
            show: false,
    ...
    toVote(e){
        ...
        let cid = this.GetQueryString('combId');
    ...
    render() {
        ...
        return (
            <div className='m-main'>
                ...
                <div className='m-info flex'>
                    <div className='m-info-content'>
                        ...
                        <div className='info method'>
                            ...
                            <li className='flex'><em>1</em><p>活动仅限18岁-35岁女性,每组限2人参与,其中1人填写信息,完成后发闺蜜接力确认参与</p></li>
                ...
                <div className='m-btn flex' style={{display:'none'}}>
