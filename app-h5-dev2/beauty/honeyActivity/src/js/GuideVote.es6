...
// 创建React组件
export class GuideVote extends BaseComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <div className="guide-box">
                ...
                <div className="guide-step flex">
                    <span className="number">2</span><span className="flex-cell">输入关键字“投票”</span>
                </div>
                <div className="guide-step flex">
                    <span className="number">3</span><span className="flex-cell">打开公众号自动推送的链接，选择你喜欢的闺蜜组合进行投票</span>
                </div>
