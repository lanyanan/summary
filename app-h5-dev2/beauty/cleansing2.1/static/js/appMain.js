...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SettingButton = __webpack_require__(8);
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        this.items.map(function (item, index) {
	                            return React.createElement(
	                                'div',
	                                { className: 'item', key: index, 'data-index': index, onTouchStart: _this2.startTouch.bind(_this2), onTouchMove: _this2.moveTouch.bind(_this2), onTouchEnd: _this2.endTouch.bind(_this2) },
	                                React.createElement(
	                                    'p',
	                                    null,
	                                    item.name
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement('div', { className: _this2.state.smartModeSwitch === 0 ? 'arrow-right' : '' }),
...
/***/ function(module, exports) {
	...
	"switchStateChange", "changeGears", 'submit']);
	    ...
	    onRepaint: function onRepaint(data) {
	        ...
	        if (!needSave) {
	            ...
	            if (AppData.smartModeSwitch == 1) {
	                ...
	                if (data.currentRunConfig) {
	                    AppData.currentConfig = _fun.Funs._extends(AppData.currentConfig, data.currentRunConfig);
	                } else {
