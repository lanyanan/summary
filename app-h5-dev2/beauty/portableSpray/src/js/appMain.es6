...
var App = React.createClass({
    ...
    componentDidMount: function(){
        mytoast("为使便携喷雾仪的使用效果更好，请先使用测肤仪进行肤质测试...");
    },
    ...
    handlerTounch : function(e) {        // 自动和手动模式切换
    ...
    render: function() {
        ...
        var tips = [
            (<span>为使便携喷雾仪的使用效果更好，推荐您先使用测肤仪进行肤质测试...<a href="cbeauty://cbeauty_skintest">去测试肌肤&gt;&gt;</a></span>),
            ...
            <div>
                <div>
                    <section className="screen-ctn">
                        ...
                        {+busiSwitch==1?(
                            <div className="gear-choose" style={slideStyle} data-busi="1" onTouchEnd={this.handlerTounch}>
                                <div className="gear-txt">自动</div>
                                <div className="gear-circle"></div>
                            </div>):(
                            <div className="gear-choose" style={slideStyle} data-busi="0" onTouchEnd={this.handlerTounch}>
                                <div className="gear-txts">手动</div>
                                <div className="gear-circle gear-circles"></div>
                            </div>
                        )}
	                    <div className="model-info clearfix">
							<div className="model" onTouchEnd={this.changeMode}>
