...
export class DevScreen extends BaseComponent{
    ...
    render() {
        let tips = [
            (<span>为使康茵美彩光美容仪的使用效果更好，推荐您先使用测肤仪进行肤质测试...<a href="cbeauty://cbeauty_skintest">去测试肤质&gt;&gt;</a></span>),
            (<span>您当前肤质为{this.props.skinType}，推荐您使用{this.props.recommendMode}模式！美丽女人是养出来的~</span>),
            (<span>您使用了康茵美彩光美容仪后，脸部皮肤水分提升了{this.props.moisture}%，请继续保持~</span>)
        ];
        let index = this.props.skinDataCode;
        return (
            <section className="screen">
                {this.props.busiSwitch=="1"?(
                    <div className="gear-choose" onTouchEnd={this.handleBusiSwitch.bind(this)}>
                ...
                <div className="pic">
                    <img src="../static/img/ico-kym.png" />
