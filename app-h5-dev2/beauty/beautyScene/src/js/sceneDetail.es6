...
export class SceneDetail extends BaseComponent {
    constructor(props) {
        super(props);
        this.state = {
            strategyId: this.props.params.strategyId || 43,
            successShow: false,
            failShow: false,
            unbindShow: false
        };
                            ...
                            <div className="device-detail">
                                ...
                                {item.deviceInfo ? (
                                    <div>
                                        ...
                                        <div className="btn" data-stepId={item.stepId} data-bind={item.deviceInfo.isBind} data-deviceTypeId={item.deviceInfo.deviceTypeId} data-deviceSubtypeId={item.deviceInfo.deviceSubtypeId} onTouchTap={this.useMode.bind(this)}>启用该模式</div>
                                    </div>
                                ) : ''}
                            </div>
                        </Link>
