...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = exports.Store = Reflux.createStore({
	    ...
	    onGetStrategy: function onGetStrategy(strategyId) {
	        var url = 'http://200.200.200.50/v1/app/chairdressing/strategy/details';
	        var _this = this;
	        ajax({
	            method: 'GET',
	            url: url,
	    ...
	    onGetStep: function onGetStep(stepId) {
	        var url = 'http://200.200.200.50/v1/app/chairdressing/strategy/stepInfo';
	        var _this = this;
	        ajax({
	            method: 'GET',
	            url: url,
	    ...
	    onUseMode: function onUseMode(deviceTypeId, deviceSubtypeId, stepId) {
	        ...
	        var url = 'http://200.200.200.50/v1/app/chairdressing/strategy/activateMode';
	        var _this = this;
	        ajax({
	            method: 'GET',
	            url: url,
	    ...
	    onGetSceneList: function onGetSceneList(pageIndex) {
	        var url = 'http://200.200.200.50/v1/app/chairdressing/strategy/list';
	        var _this = this;
	        ajax({
	            method: 'GET',
	            url: url,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SceneDetail = exports.SceneDetail = function (_BaseComponent) {
	    ...
	    function SceneDetail(props) {
	        ...
	        _this.state = {
	            strategyId: _this.props.params.strategyId || 43,
	            successShow: false,
	            failShow: false,
	            unbindShow: false
	        };
	    ...
	    _createClass(SceneDetail, [{
	        ...
	        value: function checkDevice(e) {
	            ...
	            if (this.deviceTypeId == 34 && this.deviceSubtypeId == 1) {
	                //电磁洁面仪
	                window.location.href = '../../cleansing2.1/page/index.html';
	            }
	                    ...
	                    return React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            item.deviceInfo ? React.createElement(
	                                ...
	                                React.createElement(
	                                    'div',
	                                    { className: 'btn', 'data-stepId': item.stepId, 'data-bind': item.deviceInfo.isBind, 'data-deviceTypeId': item.deviceInfo.deviceTypeId, 'data-deviceSubtypeId': item.deviceInfo.deviceSubtypeId, onTouchTap: _this2.useMode.bind(_this2) },
	                                    '\u542F\u7528\u8BE5\u6A21\u5F0F'
	                                )
	                            ) : ''
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StepDetail = exports.StepDetail = function (_BaseComponent) {
	    ...
	    function StepDetail(props) {
	        ...
	        _this.state = {
	            stepId: _this.props.params.stepId || 107
	        };
	        _this.listenStore(_Store.Store); // 监听Store
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExecutionEnvironment = __webpack_require__(90);

	var _BrowserProtocol = __webpack_require__(91);

	var BrowserProtocol = _interopRequireWildcard(_BrowserProtocol);

	var _RefreshProtocol = __webpack_require__(94);
