...
var APP = function(){
    ...
    this.config = function(option) {
        ...
        setTimeout(function(){
            ...
            webInterface.repaint({type:0,data:{mode:3, gears:2, updateFlag:0}});
            webInterface.repaint({type:1,data:{mode:4, gears:2, onlineStatus:2, electricity:4, des:"您使用设备后，脸部肌肤水分提升了80%！"}});
        }, 90);
    };
    // 接收web端传送的数据
