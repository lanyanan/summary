	...
	var History = function (_BaseComponent) {
	    ...
	    _createClass(History, [{
	        ...
	        value: function render() {
	            ...
	            var index = this.state.index || 2;
	            var maxtemp = this.state.highestThermometer || 0;
	            var maxtime = this.state.dateTime ? _fun.Funs.dateFormat(this.state.dateTime, 'hh:mm:ss', true) : 0;
	            var temphint = this.state.description || "--";
	            ...
	            var timeArray = this.state.timeArray instanceof Array && this.state.timeArray.length > 0 ? this.state.timeArray : ["00:00"];
	            var tempArray = this.state.tempArray instanceof Array && this.state.tempArray.length > 0 ? this.state.tempArray : ['34'];
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'label',
	                            { className: maxtemp > 38 ? 'lab his-red' : 'lab his-green' },
	                            temphint || '--'
	                        ),
	                        React.createElement(
	                            'span',
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'hisdata', onTouchEnd: this.changeData.bind(this) },
	                        React.createElement(
	                            'span',
	                            { 'data-index': 0, className: index == 0 ? "span-right span-back span-lf-radius" : "span-right span-lf-radius" },
	                            '1\u5C0F\u65F6'
	                        ),
	                        React.createElement(
	                            'span',
	                            { 'data-index': 1, className: index == 1 ? "span-back" : "" },
	                            '6\u5C0F\u65F6'
	                        ),
	                        React.createElement(
	                            'span',
	                            { 'data-index': 2, className: index == 2 ? "span-left span-back span-rf-radius" : "span-left span-rf-radius" },
	                            '24\u5C0F\u65F6'
	                        )
	                    )
	                ),
	                React.createElement(_Echarts.Echarts, { timelist: new_timeArray, thermometerAlert: this.state.thermometerAlert, templist: new_tempArray, getdata: data, tabIndex: this.state.index, timeArray: timeArray })
	            );
	        }
	    }, {
	        ...
	        setTimeout(function () {
	            ...
	            if (data != '') {
	                var sucCallback = function sucCallback(dd) {
	                    // console.log(dd);
	                    //dd = JSON.stringify({"data": [{"date": "2016-12-12"},{"date": "2016-12-14"},{"date": "2016-12-16"},{"date": "2016-12-19"}],"code": 0});
