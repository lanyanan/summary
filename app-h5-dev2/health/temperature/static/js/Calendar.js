...
(function(global, factory) {
    ...
    Calendar.prototype = $.extend({}, Widget.prototype, {
        ...
        tplCalendarWrap: function() {
            ...
            html += '<span class="pre-mon"></span><span class="titleicon"></span>' +'<span class="title-wrap">' + '<span class="year">' + this.get('year') + '</span> 年 ' + '<span class="month">' + this.get('month') + '</span> 月 ' + '<span class="head-text">' + this.get('headText') + '</span>' + '</span>' + '<span class="next-mon"></span>' + '</div>' + '<div class="days">' + '<span>日</span><span>一</span><span>二</span><span>三</span><span>四</span><span>五</span><span>六</span>' + '</div>' + '</div>';
