	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            setTimeout(function () {
	                ...
	                _Actions.Actions.lastBloodPressure(ajaxData);
	            }, 500);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var color = ['#FF503D', '#FEB179'],
	                text = ['收缩压', '舒张压'];
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'flex', style: { marginTop: '-25px' } },
	                        React.createElement(
	                            'div',
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    'span',
	                                    { className: 'flex-cell', style: { margin: '0' } },
	                                    this.state.latestSystolicPressure
	                                ),
	                                React.createElement(
	                                    'span',
	                                    { className: 'flex-cell' },
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    'span',
	                                    { className: 'flex-cell', style: { margin: '0' } },
	                                    this.state.lastDiastolicPressure
	                                ),
	                                React.createElement(
	                                    'span',
	                                    { className: 'flex-cell' },
	                ...
	                React.createElement(_HistoryEcharts.HistoryEcharts, { type: 'bp', text: text, color: color, oneYAxis: 1 })
	            );
	        }
	    }]);
