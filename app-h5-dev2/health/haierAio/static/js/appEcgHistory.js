...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EcgHistoryDetial = __webpack_require__(11);
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            setTimeout(function () {
	                ...
	                _Actions.Actions.getECGHistoryData(ajaxData);
	            }, 100);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return React.createElement(
	                'div',
	                { className: 'ecg-history flex-column' },
	                React.createElement(
	                    'section',
	                    { className: 'flex-cell history-list' },
	                    this.state.history.map(function (mItem, i1) {
	                        var date = ((mItem.data[0] || {}).data[0] || {}).dataTime;
	                        return React.createElement(
	                            'ul',
	                            { key: i1 },
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    'h2',
	                                    null,
	                                    _fun.Funs.dateFormat(date, 'M月', true)
	                                )
	                            ),
	                            mItem.data.map(function (dItem, i2) {
	                                var date = (dItem.data[0] || {}).dataTime;
	                                return React.createElement(
	                                    'li',
	                                    { key: i2 },
	                                    React.createElement(
	                                        'h3',
	                                        null,
	                                        _fun.Funs.dateFormat(date, 'd日', true)
	                                    ),
	                                    dItem.data.map(function (it, i3) {
	                                        var url = '#/detail/' + _this3.state.appId + '/' + _this3.state.memberId + '/' + _this3.state.userType + '/' + it.dataId;
	                                        return React.createElement(
	                                            'dl',
	                                            { key: i3, onClick: function onClick() {
	                                                    return location.href = url;
	                                                } },
	                                            React.createElement(
	                                                'dt',
	                                                null,
	                                                _fun.Funs.dateFormat(it.dataTime, 'hh:mm', true)
	                                            ),
	                                            React.createElement(
	                                                'dd',
	                                                null,
	...
	het.domReady(function () {
	    ...
	    ReactDOM.render(React.createElement(
	        ...
	        React.createElement(Route, { path: '/detail/:appId/:memberId/:userType/:id', component: _EcgHistoryDetial.EcgHistoryDetial })
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EcgHistoryDetial = undefined;
	...
	// 创建React组件
	var EcgHistoryDetial = exports.EcgHistoryDetial = function (_BaseComponent) {
	    _inherits(EcgHistoryDetial, _BaseComponent);

	    function EcgHistoryDetial(props) {
	        _classCallCheck(this, EcgHistoryDetial);

	        var _this = _possibleConstructorReturn(this, (EcgHistoryDetial.__proto__ || Object.getPrototypeOf(EcgHistoryDetial)).call(this, props));
	    ...
	    _createClass(EcgHistoryDetial, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _Actions.Actions.getHeartRateDetail(ajaxData);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            console.log(this.state);
	            var time = this.state.detail ? _fun.Funs.utcToLocal(this.state.detail.dataTime) : '',
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(_HeartRateChart.HeartRateChart, { data: this.state.detail || [] })
	                )
	            );
	        }
	    }]);

	    return EcgHistoryDetial;
	}(_BaseComponentClass.BaseComponent);
