...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_BaseComponent) {
	    ...
	    function App(props) {
	        ...
	        _this.state = { testState: 1, nickname: ' ' };
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var testing = this.state.testState == 1 ? 'switchChang-active' : '',
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'a',
	                    { className: 'mea-header' },
	                    React.createElement('img', { src: this.state.img ? this.state.img : './../static/img/user-mes.png' }),
	                    React.createElement(
	                        'span',
	                        null,
	                        '你好，',
	                ...
	                React.createElement(
	                    'ul',
	                    { className: 'switchChang' },
	                    React.createElement(
	                        'li',
	                        { className: testing + ' mea-fat' },
	                        React.createElement('img', { src: './../static/img/measure_pic.png' })
	                    ),
	                    React.createElement(
	                        'li',
	                        { className: scanning + ' mea-fat-scanning' },
	                        React.createElement('img', { src: './../static/img/scanning.png' })
	                    ),
	                    React.createElement(
	                        'li',
	                        { className: suc + ' mea-fat-suc' },
	                        React.createElement('img', { src: './../static/img/meaSuc.png' }),
	                        React.createElement(
	                            'span',
	                            {
	                                className: 'user-body-data' },
	                            this.state.weight,
	                            React.createElement(
	                                'span',
	                    ...
	                    React.createElement(
	                        'li',
	                        { className: tryAgain + ' mea-fat-t' },
	                        React.createElement(
	                            'div',
	                            { className: 'mea-fat-dis' },
	                            React.createElement(
	                                'span',
	                                { className: 'mea-fat-again' },
	                                '抱歉,无法连接到体脂秤'
	                            ),
	                            React.createElement(
	                                'a',
	                                {
	                                    className: 'mea-fat-button', href: 'health://skip_url/measureBalance/tryAgain' },
	                                '再试一次'
	                            )
	                        )
	                    )
