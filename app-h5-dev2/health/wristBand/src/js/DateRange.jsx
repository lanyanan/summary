...
export const DateRange = React.createClass({
    render(){
        ...
        return (
            <section className={data.showClndr ?"calendar-module expansion":"calendar-module"}>
                <a className={data.showClndr?'transparent':'expansion-btn'} onTouchEnd={data.handleClndr} href="request://showCalendar">
                ...
                </a>
                {
                    data.showClndr ?
                        <section className="calendar-wrap">
                            <a className="calendar-ctrl" id="calendar-ctrl" onTouchStart={data.handleClndr} href="request://hideCalendar"> </a>
