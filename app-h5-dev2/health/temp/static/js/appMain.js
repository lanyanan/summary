...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TempHint = __webpack_require__(12);
	    ...
	    _createClass(App, [{
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { href: 'health://skip_url/membersList' },
	                            React.createElement('img', { className: 'photo', src: this.state.img == '' || this.state.memberId != 0 ? '../static/img/ic-toadd.png' : this.state.img, alt: '\u5934\u50CF' }),
	                            React.createElement(
	                                'span',
	                                { className: 'fs16 nikename' },
	                                this.state.nickname == '' ? '添加家庭成员' : this.state.nickname
	                            )
	                        ),
	                        React.createElement(
	                            'p',
	                        ...
	                        React.createElement(
	                            'p',
	                            { className: this.state.temp > 37.2 ? "tip cor-red" : 'tip' },
	                            this.state.temp > 37.2 ? "有点发烧了，请注意观察" : '一枚安静又体贴的体温贴~'
	                        ),
	                        React.createElement(_TempHint.TempHint, { value: this.state.temp })
	                    )
	                ),
	                React.createElement(_Echarts.Echarts, { timelist: this.state.timeArray, templist: this.state.tempArray }),
	                React.createElement(
	                    'a',
	                    { className: 'flex', id: 'hsty-btn', href: 'health://skip_url/history.html' },
	                    '\u5386\u53F2\u6570\u636E'
	                )
	            );
	        }
	        ...
	        value: function componentWillUpdate() {
	            if (this.state.dataTime) {
	                var dataTime = _fun.Funs.dateFormatFull(this.state.dataTime, "-", 1),
	...
	var TempHint = exports.TempHint = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement('span', { style: { 'left': toLeft, 'top': toTop } })
	        );
	    }
	});
