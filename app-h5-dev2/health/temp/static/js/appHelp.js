...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_BaseComponent) {
	    ...
	    _createClass(App, [{
	        key: 'stepShow',
	        value: function stepShow() {
	            var stepShow = this.state.stepShow === 0 ? 1 : 0;
	            this.setState({ stepShow: stepShow });
	        }
	    }, {
	        key: 'chartShow',
	        value: function chartShow() {
	            var chartShow = this.state.chartShow === 0 ? 1 : 0;
	            this.setState({ chartShow: chartShow });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var stepArrow = this.state.stepShow === 0 ? '../static/img/ic-right.png' : '../static/img/ic-down.png';
	            var tempArrow = this.state.chartShow === 0 ? '../static/img/ic-right.png' : '../static/img/ic-down.png';
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'dt',
	                            { onClick: this.stepShow.bind(this) },
	                            React.createElement(
	                                'span',
	                                null,
	                                '\u4F7F\u7528\u6B65\u9AA4'
	                            ),
	                            React.createElement('img', { className: 'arrow', src: stepArrow })
	                        ),
	                        this.state.stepShow === 0 ? '' : React.createElement(
	                            'section',
	                            { className: 'step' },
	                            React.createElement(
	                                'p',
	                            ...
	                            React.createElement('img', { className: 'helpimg', src: '../static/img/ic-helpmain.png', alt: '\u4F7F\u7528\u5E2E\u52A9' })
	                        ),
	                        React.createElement(
	                            'dt',
	                            { style: { borderTop: '1px solid #FAFAFA' }, onClick: this.chartShow.bind(this) },
	                            React.createElement(
	                                'span',
	                                null,
	                                '\u6B63\u5E38\u4EBA\u4F53\u4F53\u6E29'
	                            ),
	                            React.createElement('img', { className: 'arrow', src: tempArrow })
	                        ),
	                        this.state.chartShow === 0 ? '' : React.createElement(
	                            'section',
	                            { className: 'chart' },
	                            React.createElement('img', { className: 'helpimg', src: '../static/img/ic-helpchart.png', alt: '\u4F53\u6E29\u8868' })
	                        )
	                    )
	                )
	            );
