	...
	var App = function (_BaseComponent) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function handleModeShow(e) {
	            ...
	            this.state.online != 2 && this.state.networkavailable != 2 && het.toast('chealth_potmode_set');
	        }
	        //选择控件设置
	        ...
	        value: function render() {
	            ...
	            if (AppData.slideCount != 0 && this.state.fold == true && this.state.slide == 2) {
	                ...
	                het.toast('chealth_potmode_save'); //必须点击展开了，且返回值为slide：2防止误发
	            }
	            //状态设置
	            var ArrayInit = null;
	            ...
	            return React.createElement(
	                ...
	                React.createElement(_TimeSelect.TimeSelect, { title: selectTitle,
	                    ...
	                    hourarray: hourarray,
	                    ArrayInit: ArrayInit }),
	                React.createElement('section', { id: 'mytoast' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingMode = exports.SettingMode = React.createClass({
		...
		handleModeChange: function handleModeChange(e) {
			...
			het.toast('chealth_potmode_save'); //发送给App做抽屉折叠
		},
		render: function render() {
			//接收组件传递
			var Mode = this.props.settingMode;
