...
export class SingleCourse extends Component {
    ...
    componentDidMount(){
        this.initIscroll();
        Actions.getCourseList1(this.state.pageIndex);
        ...
        this.myScroll.on('scrollEnd',function(){
            ...
            if(step==2){
                if(pullDown.className=='flip'){
                    ...
                    pullDown.className = '';
                    step = 0;
                    Actions.getCourseList1(_this.state.pageIndex);
                }
                if(pullUp.className=='flip'){
                    ...
                    ++pageIndex;
                    Actions.getCourseList1(pageIndex);
                }
            }
        })
    }
        ...
        return (
                ...
                <div id='wraper'>
                    <div id='scroller'>
                        ...
                        <div className='single-course flex'>
                            {list}
                        </div>
