...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sceneDetail = __webpack_require__(8);

	var _stepDetail = __webpack_require__(9);
	...
	het.domReady(function () {
	    ...
	    ReactDOM.render(React.createElement(
	        ...
	        React.createElement(Route, { path: '/sceneDetail/:strategyId', component: _sceneDetail.SceneDetail }),
	        React.createElement(Route, { path: '/stepDetail/:stepId', component: _stepDetail.StepDetail })
...
/***/ function(module, exports) {
	...
	var Actions = exports.Actions = Reflux.createActions(['getStrategy', //获取方案详情
	'getStep', //获取步骤详情
	'getSceneList', //获取场景列表
	'useMode']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = exports.Store = Reflux.createStore({
	    ...
	    onGetStrategy: function onGetStrategy(strategyId) {
	        var _this = this;
	        var sucFuc = function sucFuc(token) {
	            var url = docker.host + '/v1/app/chairdressing/strategy/details';
	            ajax({
	                method: 'GET',
	                url: url,
	                data: {
	                ...
	                success: function success(res) {
	                    if (res.code == 0) {
	                        (function () {
	                            ...
	                            //过滤提拉设备
	                            data.devices.map(function (item, index) {
	    ...
	    onGetStep: function onGetStep(stepId) {
	        var _this = this;
	        var sucFuc = function sucFuc(token) {
	            var url = docker.host + '/v1/app/chairdressing/strategy/stepInfo';
	            ajax({
	                method: 'GET',
	                url: url,
	                data: {
	    ...
	    onUseMode: function onUseMode(deviceTypeId, deviceSubtypeId, stepId) {
	        //console.log(deviceTypeId,deviceSubtypeId,stepId);
	        var _this = this;
	        var sucFuc = function sucFuc(token) {
	            var url = docker.host + '/v1/app/chairdressing/strategy/activateMode';
	            ajax({
	                method: 'GET',
	                url: url,
	                data: {
	    ...
	    onGetSceneList: function onGetSceneList(pageIndex) {
	        var _this = this;
	        var sucFuc = function sucFuc(token) {
	            var url = docker.host + '/v1/app/chairdressing/strategy/list';
	            ajax({
	                method: 'GET',
	                url: url,
	                data: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SceneDetail = exports.SceneDetail = function (_BaseComponent) {
	    _inherits(SceneDetail, _BaseComponent);

	    function SceneDetail(props) {
	        _classCallCheck(this, SceneDetail);

	        var _this = _possibleConstructorReturn(this, (SceneDetail.__proto__ || Object.getPrototypeOf(SceneDetail)).call(this, props));

	        _this.state = {
	            strategyId: _this.props.params.strategyId,
	            successShow: false,
	            failShow: false,
	            unbindShow: false
	        };
	        het.setTitle('方案详情');
	        _this.deviceTypeId = null;
	        _this.deviceSubtypeId = null;
	        _this.deviceId = null;
	        _this.listenStore(_Store.Store); // 监听Store
	        _Actions.Actions.getStrategy(_this.state.strategyId);
	        return _this;
	    }

	    _createClass(SceneDetail, [{
	        key: 'useMode',
	        value: function useMode(e) {
	            var stepId = parseInt(e.currentTarget.getAttribute('data-stepId'));
	            var isBind = parseInt(e.currentTarget.getAttribute('data-bind'));
	            ...
	            if (!isBind) {
	                ...
	                _Actions.Actions.useMode(this.deviceTypeId, this.deviceSubtypeId, stepId);
	            }
	            e.stopPropagation();
	            e.preventDefault();
	        }
	        ...
	        key: 'goBind',
	        value: function goBind(e) {
	            //去绑定
	            e.stopPropagation();
	            e.preventDefault();
	            window.AppJsBridge.service.openActivity({ "params": { "target": "findDevice" }, "success": function success() {
	                    console.log('进入设备引导');
	        ...
	        value: function checkDevice(e) {
	            ...
	            if (this.deviceTypeId == 34 && this.deviceSubtypeId == 1) {
	                ...
	                var url = 'smarthome/com.het.smarthome.clife.dirver/cleansing/page/index.html?sn=' + this.deviceId;
	                window.AppJsBridge.service.applicationService.openURL({ "title": "电磁洁面仪", "url": url, "success": function success() {}, "error": function error() {} });
	            }
	            if (this.deviceTypeId == 37 && this.deviceSubtypeId == 1) {
	                //彩光导入仪
	                //window.location.href = '../../lightBeauty/page/index.html';
	                var _url = 'smarthome/com.het.smarthome.clife.dirver/lightBeauty/page/index.html?sn=' + this.deviceId;
	                window.AppJsBridge.service.applicationService.openURL({ "title": "彩光导入仪", "url": _url, "success": function success() {}, "error": function error() {} });
	            }
	            if (this.deviceTypeId == 36 && this.deviceSubtypeId == 1) {
	                //便携喷雾仪
	                //window.location.href = '../../kymSpray/page/index.html';
	                var _url2 = 'smarthome/com.het.smarthome.clife.dirver/kymSpray/page/index.html?sn=' + this.deviceId;
	                window.AppJsBridge.service.applicationService.openURL({ "title": "便携喷雾仪", "url": _url2, "success": function success() {}, "error": function error() {} });
	            }
	            this.setState({
	                successShow: false,
	                failShow: false,
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'h3',
	                        { className: 'h3' },
	                        devices.length > 0 ? '所需设备' : ''
	                    ),
	                    devices.map(function (item, index) {
	                        return React.createElement(
	                            'dl',
	                            { key: index, className: 'dl' },
	                            React.createElement(
	                                'dt',
	                                null,
	                                React.createElement('img', { src: item.productIcon })
	                            ),
	                            React.createElement('dd', { className: item.isBind ? '' : 'unbind' })
	                        );
	                    })
	                ),
	                steps.map(function (item, index) {
	                    return React.createElement(
	                        Link,
	                        { to: "/stepDetail/" + item.stepId, className: 'device', key: index, 'data-stepId': item.stepId },
	                        React.createElement(
	                            'h3',
	                            { className: 'title' },
	                            item.stepTitle
	                        ...
	                        React.createElement(
	                            ...
	                            item.deviceInfo ? React.createElement(
	                                'div',
	                                null,
	                                React.createElement(
	                                    'h3',
	                                ...
	                                React.createElement(
	                                    'section',
	                                    { className: 'high-light flex' },
	                                    React.createElement('img', { src: item.deviceInfo.productIcon }),
	                                    React.createElement(
	                                        'div',
	                                        { className: 'high-r' },
	                                        React.createElement(
	                                            'h3',
	                                            null,
	                                            item.deviceInfo.productName
	                                        ),
	                                        (item.deviceConfig || []).map(function (item, index) {
	                                            return React.createElement(
	                                                'span',
	                                                { key: index },
	                                                item.descs + ':',
	                                ...
	                                React.createElement(
	                                    'div',
	                                    { className: 'btn', 'data-stepId': item.stepId, 'data-bind': item.deviceInfo.isBind, 'data-deviceTypeId': item.deviceInfo.deviceTypeId, 'data-deviceSubtypeId': item.deviceInfo.deviceSubtypeId, 'data-deviceId': item.deviceInfo.deviceId, onTouchTap: _this2.useMode.bind(_this2) },
	                                    '\u542F\u7528\u8BE5\u6A21\u5F0F'
	                                )
	                            ) : ''
	                        )
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'cover', ref: 'success', style: { display: this.state.successShow ? 'block' : 'none' } },
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement('img', { className: 'successImg', src: '../static/img/scene-1.png' }),
	                        React.createElement(
	                            'p',
	                            { className: 'desc' },
	                            '\u8BBE\u5907\u540C\u6B65\u6210\u529F'
	                        ...
	                        React.createElement(
	                            'a',
	                            { href: '#', onTouchTap: this.checkDevice.bind(this) },
	                            '\u67E5\u770B\u6211\u7684\u8BBE\u5907'
	                        ),
	                        React.createElement(
	                            'a',
	                            { href: '#', onTouchTap: this.stayHere.bind(this) },
	                            '\u7559\u5728\u5F53\u524D\u9875\u9762'
	                        )
	                    )
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'cover', ref: 'fail', style: { display: this.state.failShow ? 'block' : 'none' } },
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement('img', { className: 'failImg', src: '../static/img/scene-2.png' }),
	                        React.createElement(
	                            'p',
	                            { className: 'desc' },
	                            '\u8BBE\u5907\u540C\u6B65\u5931\u8D25,\u8BF7\u68C0\u67E5\u624B\u673A\u7F51\u7EDC\u8BBE\u7F6E!'
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'cover', ref: 'unbind', style: { display: this.state.unbindShow ? 'block' : 'none' } },
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement(
	                        ...
	                        React.createElement(
	                            'button',
	                            { className: 'go-bind', onTouchTap: this.goBind.bind(this) },
	                            '\u53BB\u7ED1\u5B9A'
	                        ),
	                        React.createElement(
	                            'button',
	                            { className: 'no-thx', onTouchTap: this.stayHere.bind(this) },
	                            '\u4E0D\u4E86,\u8C22\u8C22!'
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StepDetail = exports.StepDetail = function (_BaseComponent) {
	    ...
	    function StepDetail(props) {
	        ...
	        _this.state = {
	            stepId: _this.props.params.stepId
	        };
	        _this.listenStore(_Store.Store); // 监听Store
	        _Actions.Actions.getStep(_this.state.stepId);
	        return _this;
	    }
	...
	var App = exports.App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            this.initIscroll();
	            _Actions.Actions.getSceneList(this.state.pageIndex);
	            ...
	            this.myScroll.on('scrollEnd', function () {
	                ...
	                if (step == 2) {
	                    if (pullDown.className == 'flip') {
	                        ...
	                        pullDown.className = '';
	                        step = 0;
	                        _Actions.Actions.getSceneList(_this.state.pageIndex);
	                    }
	                    if (pullUp.className == 'flip') {
	                        ...
	                        ++pageIndex;
	                        _Actions.Actions.getSceneList(pageIndex);
	                    }
	                }
	            });
	        }
	        ...
	        value: function render() {
	            ...
	            if (list !== undefined) {
	                items = list.map(function (item, index) {
	                    var src = item.pic;
	                    var bg = { background: 'url(' + src + ')', backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' };
	                    var tags = null;
	                    var devices = null;
	                    if (isArrayFn(item.tags)) {
	                        tags = item.tags.map(function (itm, idx) {
	                            var num = idx === 0 ? 'tag1' : '';
	                            var classN = 'tag ' + num;
	                            return React.createElement(
	                                'span',
	                                { key: idx, className: classN },
	                                itm.tagName
	                            );
	                        });
	                    }
	                    if (isArrayFn(item.devices)) {
	                        devices = item.devices.map(function (itm, idx) {
	                            var num = idx === 0 ? 'device-img1' : '';
	                            var classN = 'device-img flex ' + num;
	                            return React.createElement(
	                                'div',
	                                { className: classN, key: idx },
	                                React.createElement('img', { src: itm.productIcon })
	                            );
	                        });
	                    }
	                    ...
	                    return React.createElement(
	                        'div',
	                        { className: 'scene-list', style: bg, key: index },
	                        React.createElement(
	                            _reactRouter.Link,
	                            { to: '/sceneDetail/' + item.strategyId, onTouchTap: _this3.endTap.bind(_this3), 'data-id': item.strategyId },
	                            React.createElement(
	                                'div',
	                                { className: 'list-con flex', ref: item.strategyId },
	                                React.createElement(
	                                    'h2',
	                                    null,
	                                    item.title
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexLink2 = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createTransitionManager2 = __webpack_require__(50);
	...
	var _RouterUtils = __webpack_require__(64);
