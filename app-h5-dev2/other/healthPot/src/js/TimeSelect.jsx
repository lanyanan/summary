...
export const TimeSelect = React.createClass({
	...
	render: function() {
		...
		return (
			<section ref="selecter" style={{visibility:this.state.timeDisplay?"initial":"hidden",opacity:this.state.showOpacity}} ref='timeSelect' className='timeSelect'>
				...
				<section className="timeselect" onTouchMove={this.endDefault}>
					...
					<section className='time'>
						...
						<section className='timetext'>
							...
							<span style={{display:'none'}} className='status'>{statusname}</span>
						</section>
