...
window.het = (function() {
    ...
    function HET() {
        ...
        var settings = {
            ...
            appId: '30590', //接口所需appId参数
            appSecret: '98889238ed6e441aaf9b0691b017695f', //接口所需appSecret参数
         ...
         */
        $this.getSign = function(type, url, data) {
            ...
            signStr = signStr + "&" + settings.appSecret;
        ...
        function proxyHttp(url, data, type, sucCallback, errCallback, needArg) {
            ...
            if (type === 'GET') { // GET方式
                var callback = function(tokendata) {
                    var statusUrl = url;
                    ...
                    if (!deviceId) return;
                    var arr = ['appId','accessToken','timestamp','deviceId'];
