	...
	var App = function (_BaseComponent) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            var appSchemes = obj.appSchemes; //获取地址栏参数，判断显示隐藏下载栏
	            appSchemes && this.setState({ 'appSchemes': appSchemes });

	            var messageId = Number(obj.messageId);
	            ...
	            var getUrl = '/v1/app/cms/message/get?appId=10120&messageId=' + messageId + '&accessToken=' + accessToken + '&timestamp=' + new Date().getTime();
	        ...
	        value: function render() {
	            ...
	            var createTime = _fun.Funs.dateFormat(this.state.createTime || '', 'yyyy-MM-dd hh:mm:ss', true);
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'aside',
	                    { className: this.state.appSchemes ? 'download' : 'hide' },
	                    React.createElement(
	                        'div',
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'span',
	                            { onTouchEnd: this.downLoads.bind(this) },
	                            '\u4E0B\u8F7D\u5E94\u7528'
	                        ),
	                        React.createElement('i', { onTouchStart: this.closed.bind(this) })
	                    )
	                ),
	                React.createElement(
	                    'header',
