...
export class ColorRingView extends React.Component{
    ...
    caculateColor(e){
        ...
        let colorStr = "#"+rgba[0].toString(16)+rgba[1].toString(16)+rgba[2].toString(16);
        return colorStr;
    }
    getOffset(dom) {
        let xy = {x:0, y:0};
    ...
    render(){
        ...
        <section className={classShow} onTouchStart={this.disMiss.bind(this)} >
            <div className={ringClassName} onTouchStart={this.stopBodyScroll.bind(this)} onTouchMove={this.stopBodyScroll.bind(this)}>
                <a href="#" className="colorBar" style={{backgroundColor:this.props.colorBar}}></a>
                ...
                <a href="#" className="closeBtn" onTouchEnd={this.disMiss.bind(this)}></a>
            </div>
        </section>);
    }
};
