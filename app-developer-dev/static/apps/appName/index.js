...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PageIndex = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        for (var i = paging.startIndex; i < paging.endIndex; i++) {
	            if (i == pageIndex - 1) {
	                index.push(_react2.default.createElement('span', { className: 'curPage', key: i, id: 'currentPage' }, pageIndex));
	            } else {
	                index.push(_react2.default.createElement('a', { href: 'javascript:void(0)', key: i, onClick: this.getPager(i + 1) }, i + 1));
	            }
	        }
	        return _react2.default.createElement('span', null, index);
	    }
	});
	var PageJump = _react2.default.createClass({ // 页面跳转
	    ...
	    render: function render() {
	        return _react2.default.createElement('span', { className: 'jump' }, '\u5171', _react2.default.createElement('em', { id: 'totalPages' }, this.props.pager.totalPages), '\u9875\uFF0C\u5230\u7B2C', _react2.default.createElement('input', { type: 'text', maxLength: '5', ref: 'inputPageIndex', id: 'input-pageIndex', onChange: this.handleChange, onBlur: this.handleBlur }), '\u9875', _react2.default.createElement('input', { type: 'button', value: '\u786E\u5B9A', className: 'btn-jump', onClick: this.handleClick }));
	    }
	});
	var Pager = exports.Pager = _react2.default.createClass({
	    render: function render() {
	        ...
	        return _react2.default.createElement('div', { className: 'manage-paging' }, isFirstPage, isBtnPrev, _react2.default.createElement(PageIndex, { pager: this.props.pager, getPager: this.props.getPager }), isBtnNext, isLastPage, _react2.default.createElement(PageJump, { pager: this.props.pager, getPager: this.props.getPager }));
	    }
	});
	    ...
	    _createClass(Header, [{
	        ...
	        value: function getComponent() {
	            return _react2.default.createClass({
	                ...
	                render: function render() {
	                    return _react2.default.createElement('header', { className: 'header' }, _react2.default.createElement('div', { className: 'h-pannel' }, "\u667A\u80FD\u8BBE\u5907\u81EA\u52A9\u63A5\u5165\u7CFB\u7EDF"), _react2.default.createElement('div', { className: 'h-btns' }, _react2.default.createElement('a', { href: '#', className: 'tools-slide', title: "\u6536\u8D77\u5DE5\u5177\u680F", onClick: this.handleClick }, this.state.toolsUnfolded ? '-' : '+')));
	                }
	            });
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reflux = __webpack_require__(162);
	...
	var Actions = exports.Actions = _reflux2.default.createActions(['loadStoreData', // 加载Store
	'saveProject', // 保存项目
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _HeaderPanel = __webpack_require__(159);
	...
	module.exports = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement('div', { className: 'publish-body' }, _react2.default.createElement('section', { className: 'title' }, _react2.default.createElement('label', { className: 'left' })), _react2.default.createElement('section', { className: 'remark-area' }, _react2.default.createElement('div', { className: 'remark' }, _react2.default.createElement('p', { className: 'item' }, _react2.default.createElement('label', null, '\u9879\u76EE\u540D\u79F0:'), _react2.default.createElement('span', { id: 'title', contentEditable: 'true' }, this.props.title)), _react2.default.createElement('p', { className: 'item' }, _react2.default.createElement('label', null, '\u8BF4\u660E:'), _react2.default.createElement('textarea', { placeholder: '\u8BF7\u8F93\u516520-200\u5B57\u4EE5\u5185\u7684\u53D1\u5E03\u8BF4\u660E', defaultValue: this.props.remark, className: 'item', id: 'remark' }))), _react2.default.createElement('div', { className: 'btn-grp' }, _react2.default.createElement('button', { onClick: this.publish }, '\u53D1\u5E03'), _react2.default.createElement('button', { onClick: this.goToPrev }, '\u8FD4\u56DE'))));
	  }
	});
