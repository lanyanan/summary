...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QRCode = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement('div', { className: 'app-body' }, _react2.default.createElement('section', { className: 'text' }, _react2.default.createElement('div', { className: 'right', onClick: this.powerHandler }, 'X')), _react2.default.createElement('section', { className: 'picture' }, _react2.default.createElement('div', { id: 'qrcode' }, _react2.default.createElement('div', { className: 'img' }, _react2.default.createElement('img', { className: 'power', src: '../static/img/preview.png' })), _react2.default.createElement('div', { id: 'codeWrap' })), _react2.default.createElement('div', { className: 'right' }, _react2.default.createElement('div', { style: { width: "100%", height: '100%', backgroundColor: '#ffffff' } }, _react2.default.createElement('iframe', { src: this.props.url, width: '100%', height: '100%' })))));
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/(function (e, t) {
	  ...
	  }), e.jQuery = e.$ = b, "function" == "function" && __webpack_require__(182) && __webpack_require__(182).jQuery && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return b;
