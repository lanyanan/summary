    ...
    getComponent: _react2.default.createClass({
        ...
        render: function render() {
            ...
            widgetList.map(function (widget) {
                listTotal.push(widget);
                if (widget.id === 1019 && widget.widgetListItem != '') {
                    widget.widgetListItem.map(function (tabList) {
                        tabList.map(function (widgetGrandchild) {
                            listTotal.push(widgetGrandchild);
                        });
                    });
                }
            });
