...
export let TimeProperty = {
	getComponent : React.createClass({
        ...
        render: function(){
            ...
            return (
                <div>
                <section className='sizeproperty' style={{display:isText?'block':'none'}}>
                    <span>内容</span>
                ...
                <section className='status' style={{display:!isText?'block':'none'}}>
                ...
                <section className='event' style={{display:!isText?'block':'none'}}>
