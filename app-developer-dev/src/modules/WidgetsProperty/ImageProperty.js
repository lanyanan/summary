...
var ImageProperty = exports.ImageProperty = {
    getComponent: _react2.default.createClass({
        ...
        render: function render() {
            ...
            var scheme = this.props.scheme ? this.props.scheme : '';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        null,
                        this.props.showStall ? '档位名称' : scheme.indexOf('mode') > -1 ? '模式' : '状态名称'
                    ),
                    _react2.default.createElement('input', { className: 'picname', value: I.statusName, onChange: this.showFocus,
                        onFocus: this.showFocus, placeholder: scheme.indexOf('mode') > -1 ? '请填写模式名' : '请填写状态名' }),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('span', { className: 'delete-img', onClick: this.deleteImg })
                    )
                )
            );
        }
