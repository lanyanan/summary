...
exports.DragCodePanelClass = undefined;
...
var DragCodePanelClass = exports.DragCodePanelClass = function (_BaseClass) {
    _inherits(DragCodePanelClass, _BaseClass);

    function DragCodePanelClass() {
        _classCallCheck(this, DragCodePanelClass);

        var _this = _possibleConstructorReturn(this, (DragCodePanelClass.__proto__ || Object.getPrototypeOf(DragCodePanelClass)).call(this));
    ...
    _createClass(DragCodePanelClass, [{
        key: 'getMoveDom',
        ...
        value: function onMove(dom, x, y) {
            ...
            this.oldMoveY = y;
            (0, _pubsub.publish)('codepanel_resize', offsetY);
        }
