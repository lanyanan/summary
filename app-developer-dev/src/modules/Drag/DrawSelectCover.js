...
exports.DrawSelectCoverClass = undefined;
...
var DrawSelectCoverClass = exports.DrawSelectCoverClass = function (_BaseClass) {
    _inherits(DrawSelectCoverClass, _BaseClass);

    function DrawSelectCoverClass() {
        _classCallCheck(this, DrawSelectCoverClass);

        var _this = _possibleConstructorReturn(this, (DrawSelectCoverClass.__proto__ || Object.getPrototypeOf(DrawSelectCoverClass)).call(this));
    ...
    _createClass(DrawSelectCoverClass, [{
        key: 'getMoveDom',
        ...
        value: function onMove(dom, x, y) {
            ...
            _Actions.Actions.drawSelectCover(true, top, left, width, height);
        }
        ...
        value: function onEnd(dom, x, y) {
            _Actions.Actions.drawSelectCover(false);
            (0, _pubsub.publish)('end_drag_user_widget', 0, 0, 0); // 发布消息：拖放结束
        }
    }]);

    return DrawSelectCoverClass;
}(_Base.BaseClass);