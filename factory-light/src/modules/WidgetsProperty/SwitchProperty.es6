            ...
            return (
                    ...
                    <section className='status'>
                        <div className='switchproperty'>
                            <label onClick={this.changeSwitch.bind(this,1)} className={switchValue==1?'active':''}>开</label>
                            <label onClick={this.changeSwitch.bind(this,2)} className={switchValue==2?'active':''}>关</label>
                        </div>
                        <div>
                        <span className='statustitle'>状态</span>
                        <span className={'toggle '+(this.props.showStatus==i?'on':'off')} style={{top:this.props.showStatus==i?(54+'px'):(55+'px')}} data-index={i} onClick={this.toggleStatusDiv}></span>
                        <div style={{display:(this.props.showStatus==i?'':'none')}} className='showproperty'>
                            <span>状态优先显示</span>
                        ...
                        <section style={{display:(this.props.showStatus==i?'':'none')}}>
                            <span>字段</span>
                    ...
                    <section className='event'>
                        ...
                        <section data-pid={i} data-type={q} onClick={this.changeEvent}>
                            ...
                            {/*<select data-pid={i} value={eventSet.eventType} data-type = {q} onChange={this.changeEvent}>
