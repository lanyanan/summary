            ...
            return (
                <div className ='rangeproperty'>
                    <section className='status'>
                        ...
                        <div className='showproperty' style={{display:rangeNumber===-1?'block':'none'}}>
                            <span>显示档位</span>
                            <input type='checkbox' data-type='stallShow' style={{marginLeft:185+'px'}} className={"checkstatus "+(stallShow?'on':'off')} onChange={this.changeRangeSet} checked={stallShow}  />
                        </div>
                    </section>
