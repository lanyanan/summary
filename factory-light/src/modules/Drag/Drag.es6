...
import {DragWidgetClass} from './DragWidget.es6'; // 控件拖放处理类
import {DragResizeClass} from './DragResize.es6'; // 调节大小拖放处理类
import {DragPanelClass} from './DragPanel.es6'; // 面板拖放处理类
import {DragUserWidgetClass} from './DragUserWidget.es6'; // 用户控件拖放处理类
import {DragCanvasClass} from './DragCanvas.es6'; // 用户控件拖放处理类
import {DrawSelectCoverClass} from './DrawSelectCover.es6'; // 多选cover区域处理类
//import {DragCodePanelClass} from './DragCodePanel.es6'; // 多选cover区域处理类
